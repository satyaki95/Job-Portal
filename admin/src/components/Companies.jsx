  ...
  useEffect(() => {
    const fetchCompanies = async () => {
      try {
        ...
        const companyList = Array.isArray(res?.data?.companies)
          ? res.data.companies
          : [];
    ...
    <div className={s.pageContainer}>
      {toast && (
        <div className={s.toastWrapper}>
          <div
            className={`${s.toastBase} ${toast.type === "success" ? s.toastSuccess : toast.type === "error" ? s.toastError : s.toastConfirm}`}
          >
            {toast.type === "success" ? (
