...
// simple CSV parser that handles quoted fields and commas inside quote
              ...
              <div className={s.colSpan2}>
                ...
                <div className={s.inputWrapper}>
                  ...
                  <input
                    ...
                    className={`${s.inputField} ${errors.companyName ? s.inputError : s.inputDefault}`}
              ...
              <div>
                ...
                <div className={s.inputWrapper}>
                  ...
                  <input
                    ...
                    className={`${s.inputField} ${errors.questionsCount ? s.inputError : s.inputDefault}`}
                        ...
                        {q.keyPoints && q.keyPoints.length > 0 && (
                          <div className={s.keyPointsSection}>
                            ...
                            <ul className={s.keyPointsList}>
                              {q.keyPoints.map((kp, kdx) => (
                                <li key={kdx} className={s.keyPointItem}>
                                  <CircleDashed
                                    size={14}
