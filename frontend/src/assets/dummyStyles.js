...
export const viewProfilePageStyles = {
  // Container styles
  container:
    "min-h-screen font-[pacifico] bg-linear-to-br from-indigo-50 via-white to-purple-50 py-8 sm:py-12 px-4 sm:px-6 lg:px-8",
  innerContainer:
    "max-w-full sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-4xl mx-auto",

  // Header styles
  header:
    "flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 animate-fade-in-down gap-4",
  headerTitle:
    "text-3xl sm:text-4xl font-bold bg-linear-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent",

  // Edit button
  editButton:
    "group w-full sm:w-auto cursor-pointer flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-linear-to-r from-indigo-600 to-purple-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300",
  ...
  cancelButton:
    "flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-gray-200 text-gray-700 font-semibold hover:bg-gray-300 transition-all duration-300 w-full sm:w-auto",
  cancelIcon: "w-5 h-5",
  saveButton:
    "flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-linear-to-r from-green-500 to-emerald-600 text-white font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto",
  ...
  // Profile card
  profileCard:
    "bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 border border-white/20 animate-fade-in-up",

  // Avatar section
  avatarSection:
    "flex flex-col sm:flex-row sm:items-center gap-4 mb-6 pb-4 sm:pb-6 border-b border-gray-200/50",
  avatar:
    "shrink-0 rounded-full bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold shadow-xl w-16 h-16 sm:w-24 sm:h-24 md:w-28 md:h-28 lg:w-24 lg:h-24 xl:w-24 xl:h-24 text-2xl sm:text-3xl md:text-4xl",
  avatarInfo: "flex-1",
  avatarName: "text-xl sm:text-2xl md:text-2xl font-bold text-gray-800",
  avatarEmail:
    "text-gray-500 flex items-center gap-2 mt-1 text-sm sm:text-base",
  ...
  // Input styles
  input:
    "w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200 transition-all bg-white/50 text-sm sm:text-base",
  displayText:
    "text-gray-800 px-4 py-3 bg-gray-50/50 rounded-xl border border-gray-100 text-sm sm:text-base",
  ...
  resumeUploadBox:
    "w-full px-4 py-3 rounded-xl border border-gray-200 bg-white/50 flex items-center gap-2 text-gray-500 hover:bg-gray-100 transition-colors text-sm sm:text-base",
  resumeUploadIcon: "w-5 h-5 text-indigo-600",
  resumeFileName: "truncate",
  resumeDeleteButton:
    "p-3 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 transition-colors border border-red-200 shrink-0",
  resumeDeleteIcon: "w-5 h-5",
  resumeSuccessText: "text-sm text-green-600 truncate",

  // Resume view button
  resumeViewButton:
    "inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-700 rounded-xl border border-indigo-200 hover:bg-indigo-100 transition-colors text-sm sm:text-base cursor-pointer",
