...
const Toast = ({ message, type, onClose }) => {
  ...
  return (
    <div className={s.toastWrapper}>
      <div
        className={`${s.toastContent} ${type === "success" ? s.toastSuccess : s.toastError}`}
      >
        <div className="relative">
          <div
            className={`${s.toastDot} ${type === "success" ? s.toastSuccess : s.toastError}`}
          ></div>
          <div
...
const ImageUpload = ({ image, setImage, error }) => {
  ...
  }, [image]); // to preview the image uploaded
