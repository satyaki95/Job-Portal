      ...
      <div className={s.contentWrapper}>
        ...
        <div className={s.formGrid}>
          <div className={s.formColumn}>
            <div className={s.card}>
              <label className={s.cardLabel}>
                <Briefcase className={s.labelIcon} />
            ...
            <div className={s.card}>
              <label className={s.cardLabel}>
                <Image className={s.labelIcon} />
                Upload Image <span className={s.requiredStar}>*</span>
              </label>
              <div
          ...
          <div className={s.formColumn}>
            <div className={s.card}>
              <label className={s.cardLabel}>
                <FileText className={s.labelIcon} />
                Upload CSV <span className={s.requiredStar}>*</span>
              </label>
              <div
                className={s.dropzone}
                ...
                {csvFile ? (
                  ...
                  <>
                    ...
                    <p className={s.uploadHint}>
                      ...
                      company, date). Use ; | inside a cell for multiple values.
                      Company may include date: `Google (2026-04-10)`
                    </p>
                  </>
                )}
                <input
        ...
        {questions.length > 0 && (
          <div className={s.questionsSection}>
            <h2 className={s.sectionTitle}>
              Loaded Question ({questions.length})
            </h2>
