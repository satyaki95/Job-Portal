...
const ViewProfilePage = () => {
  ...
  // to open the uploaded resume on the chrome or default browser
  const handleViewResume = () => {
    ...
    if (profile.resume instanceof File) {
      ...
      const fullUrl = `${baseURL}/api/user/resume/${originalProfile._id}`;
                  ...
                  <div className={s.resumeUploadWrapper}>
                    ...
                    {profile.resume && (
                      <p className={s.resumeSuccessText}>
                        File uploaded:{" "}
                        {profile.resume.name || "Uploaded Resume"}
                      </p>
                    )}
                  </div>
                ) : (
