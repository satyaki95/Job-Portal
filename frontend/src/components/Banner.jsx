  ...
  const jobs = [
    {
      ...
      salary: "Rs120K",
      logo: "https://lottie.host/b7421157-b313-472d-bf32-b5ebcde40f91/dh22B7BdQF.lottie",
    },
    {
      title: "Frontend Developer",
      company: "WebFlow",
      salary: "Rs95K",
      logo: "https://lottie.host/c578cb16-f781-49d1-9804-5b09db41949a/REc8rg8m4P.lottie",
    },
    {
      title: "Data Scientist",
      company: "DataSphere",
      salary: "Rs140K",
      logo: "https://lottie.host/08be639c-bd88-4227-ae9b-e17a58354b1e/GYkQVrTWMZ.lottie",
    },
  ];
                      ...
                      <div key={index} className={s.jobItem}>
                        <div className={s.jobItemFlex}>
                          ...
                          <div className={s.salaryContainer}>
                            ...
                            <div className={s.salaryPeriod}>par year</div>
                          </div>
                        </div>
